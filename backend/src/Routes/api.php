...
use App\Controllers\OrganizationSpotlightController;
...
$organizationSpotlightController = new OrganizationSpotlightController();
...
$router->post('/api/v1/auth/change-password', [$authController, 'changePassword'], [$auth]);
...
$router->get('/api/v1/organization-spotlight', [$organizationSpotlightController, 'publicShow']);
$router->get('/api/v1/leadership-profiles', [$memberController, 'publicLeadershipIndex']);
$router->get('/api/v1/committee-members', [$memberController, 'publicCommitteeIndex']);
...
$router->get('/api/v1/admin/organization-spotlight', [$organizationSpotlightController, 'adminShow'], [$auth, $adminOnly]);
$router->post('/api/v1/admin/organization-spotlight', [$organizationSpotlightController, 'update'], [$auth, $adminOnly]);
